...
export function validationSchema () {
	yup.object().shape( {
		...
		//criar máscara para o cpf: não aceitar números repetidos
		email: yup
			.string()
		...
		// colocar uma máscara ná matrícula para ele só aceitar 8 digitos ou 10 dígitos: não aceitar números repetidos
		bond: yup
			.string()
		...
		gender: yup
			...
			.required( "É obrigatório informar" ),
		...
		// consumir uma api pra colocar o estado e a cidade com selects relacionados entre si
		state: yup
			.string()
			//.matches(lettersOnly, "Apenas letras")
		...
		cep: yup
			...
			//.matches(cepNumber)
			.required( "É obrigatório informar seu CPF" ),
		bank: yup.number().required( "É obrigatório informar o banco" ),
		acountType: yup.number().required( "É obrigatório informar o tipo de conta" ),
		agency: yup.number().required( "É obrigatório informar a agência" ),
		account: yup.number().required( "É obrigatório informar o Nº da conta" ),
