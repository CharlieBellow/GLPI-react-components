...
function CardLabel(props: CardFloatingLabelTextareaProps) {
  return (
    <label
      ...
      className="absolute text-base bg-branco-gelo text-fundo-claro duration-300 transform
  ...
  return (
      <div className="relative mx-[3.625rem]">
        <textarea
          ...
          className="block px-2.5 pb-2.5 pt-4 h-[10.125rem] min-h-full max-h-[10.125rem] w-full text-base
