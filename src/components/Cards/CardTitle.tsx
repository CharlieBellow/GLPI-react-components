  ...
  return (
    <>
      ...
      {props.type === "image" ? (<div className="flex item-center">
        ...
        <div className="bg-blue-ufal rounded-full w-8 h-8 flex justify-center hover:cursor-pointer items-center text-white-100 relative top-10 -left-6"><Icon.Camera size={16} /></div>
      </div>) : <div className="bg-pink-500 w-22 h-22 -top-7 rounded-xl  -ml-3 relative"></div>}
