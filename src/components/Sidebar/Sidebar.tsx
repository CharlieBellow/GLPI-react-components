...
function Sidebar({children} :any){
    ...
    return(
        <div className="flex w-full ">
            <div data-testid="test" className={`${open ? "w-[20rem] shadow-2xl lg:w-48 lg:shadow-none" : "w-0 lg:w-16"} z-40 fixed overflow-x-hidden bg-blue-final-gradient ease-in-out duration-300 before:bg-gradient-to-r before:-z-10 lg:static lg:block lg:overflow-x-visible h-screen `}>
