...
function Sidebar({children} :any){
    ...
    return(
        <div className="flex w-full h-full">
            <div className={`${open ? "w-[20rem] shadow-2xl lg:w-48" : "w-0 lg:w-16"} z-40 fixed h-full overflow-x-hidden bg-blue-final-gradient ease-in-out duration-300 before:bg-gradient-to-r  before:-z-10 lg:static lg:block lg:h-auto lg:overflow-x-visible`}>
