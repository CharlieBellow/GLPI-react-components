						...
						<div className="flex items-center relative">
							...
							<div className="lg:w-[2.875rem] lg:h-[2.875rem] rounded-full">
								...
								<div className="lg:mt-0 mt-[-50px] lg:ml-0 ">
									<div className="lg:hidden fixed right-16 top-4 pr-6">
									...
									<div className="flex-1 flex">
										<Link to="/Login">
											<img
												...
												alt="favicon"
												className=" lg:w-[2.875rem] lg:h-[2.875rem] w-8 h-8 rounded-full lg:relative fixed right-13 top-3 lg:right-0 lg:top-0"
											/>
										</Link>
									</div>
								</div>
