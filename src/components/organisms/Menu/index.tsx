...
export function Menu() {
	return (
		<>
			<aside className="hidden lg:block lg:bg-blue-final-gradient lg:w-[13.375rem] lg:m-0 lg:z-10 ">
				<img
					src={logoUfal}
					alt="logo da ufal"
				...
				<div className="flex flex-col  pl-6 pr-5 pb-[2.063rem]">
					<h4 className="text-white-100 font-bold text-sm ">
						Geral
					</h4>
					<AccordionMenu />
				</div>
				...
				<div className="flex flex-col items-start pl-6 pr-5 pb-[2.063rem]">
					...
					<div className=" w-full flex items-center content-between">
						<p className=" text-white-100 font-semibold text-sm flex flex-row items-center content-start w-full my-5 mx-0 mr-2 hover:text-blue-dark-final-gradient">
							<Gear size={20} className="mr-2 stroke-white-100" />
							Configurações
						</p>
					</div>
					...
					<div className="w-full flex items-center content-between">
						<Link to="/Teste">
							<p className="text-white-100 font-semibold text-sm flex flex-row items-center content-start w-full my-5 mx-0 mr-2 hover:text-blue-dark-final-gradient">
								<WarningCircle
									size={20}
									className="mr-2 stroke-white-100"
								/>
								Ajuda
							</p>
						</Link>
